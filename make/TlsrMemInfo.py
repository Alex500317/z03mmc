...
def main():
	...
	sec_start = [b"__start",    b"_rstored_",      b"_start_rodata_",  b"_retention_data_start_",b"_rstored_",       b"_ictag_start_",   b"_ictag_end_", b"_start_data_", b"_start_bss_",  b"_start_bss_",  b"_end_bss_",	 b"__start"]
	sec_end   = [b"_rstored_",   b"_code_size_",  b"_end_rodata_", b"_retention_data_end_",  b"_ictag_start_",    b"_ictag_end_",  b"_ictag_end_",  b"_end_data_",   b"_end_bss_",  b"IRQ_STK_SIZE", b"__RAM_SIZE_MAX", b"_bin_size_"]
